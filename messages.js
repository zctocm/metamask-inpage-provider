module.exports = {
  ...
  warnings: {
    ...
    sendSyncDeprecation: `MetaMask: ethereum.send(requestObject) will be Promise-returning for all methods starting December 9, 2019. For details, see: TODO: add link`
  }
}
